  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (registerUser.fulfilled.match(res)) {
        // Save data to localStorage (already handled in slice)
        router.replace(parsed.data.role === 'CUSTOMER' ? '/customer' : '/partner');
      }
    } catch (err) {
    ...
    <section className="pt-20 pb-20">
      <div className="container mx-auto max-w-lg">
        <div className="bg-white shadow-lg rounded-lg p-10">
          ...
          <p className="text-center text-gray-600 mb-8">Sign up and start using our service.</p>
